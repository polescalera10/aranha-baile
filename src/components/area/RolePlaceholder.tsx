...
export function RolePlaceholder({
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container-nexus py-16">
        ...
        <div className="mt-8 rounded-lg border border-dashed border-text-strong/20 bg-bg-panel/60 p-8 font-body text-text-muted">
