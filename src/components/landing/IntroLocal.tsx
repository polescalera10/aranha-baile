 ...
 *
 * El `H1` de la home ("No vienes a una clase. Entras a una comunidad.") es
 * buen copy pero invisible para Google: no contiene ni "escuela de baile" ni
 * la localidad. Este bloque pone la intención de búsqueda en un `h2` real y de
 * paso responde en dos frases lo que un visitante nuevo necesita saber antes
 * de seguir bajando: qué es, dónde está y qué se baila.
 *
